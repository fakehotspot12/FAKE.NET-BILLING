...
test('loads the lightweight bootstrap before the full authenticated application', () => {
  ...
  assert.match(indexSource, /href="\/boot\.css\?ui=billing-nas-genie-pending-20260811"/);
  assert.match(indexSource, /src="\/bootstrap\.js\?ui=billing-nas-genie-pending-20260811"/);
