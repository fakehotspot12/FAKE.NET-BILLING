...
function ensureShape(data) {
  ...
  const shaped = {
    ...
    fiberCenters: Array.isArray(safe.fiberCenters) ? safe.fiberCenters : [],
    fiberPoints: Array.isArray(safe.fiberPoints) ? safe.fiberPoints : [],
...
async function ensurePostgresStore() {
  ...
  await runPsqlSql(`
      ...
      create index if not exists app_customers_code_json_idx on app_customers ((data->>'code'));
      create index if not exists app_customers_whatsapp_json_idx on app_customers ((data->>'whatsapp'));
      create index if not exists app_customers_phone_json_idx on app_customers ((data->>'phone'));
      create index if not exists app_customers_site_json_idx on app_customers ((data->>'site'));
      create index if not exists app_customers_status_created_json_idx on app_customers ((data->>'status'), (data->>'createdAt') desc);
      ...
      create index if not exists app_invoices_invoice_no_json_idx on app_invoices ((data->>'invoiceNo'));
      create index if not exists app_invoices_external_id_json_idx on app_invoices ((data->>'externalId'));
      create index if not exists app_invoices_period_status_json_idx on app_invoices ((data->>'period'), (data->>'status'));
      create index if not exists app_invoices_due_status_json_idx on app_invoices ((data->>'dueDate'), (data->>'status'));
      ...
      create index if not exists app_payments_method_json_idx on app_payments ((data->>'method'));
      create index if not exists app_payments_status_paid_at_json_idx on app_payments ((data->>'status'), (data->>'paidAt') desc);
      ...
      create index if not exists app_wa_messages_status_created_json_idx on app_wa_messages ((data->>'status'), (data->>'createdAt') desc);
      ...
      create index if not exists app_activity_type_at_json_idx on app_activity ((data->>'type'), (data->>'at') desc);
      create index if not exists app_expenses_date_json_idx on app_expenses ((data->>'date') desc);
      create index if not exists app_expenses_category_json_idx on app_expenses ((data->>'category'));
      create index if not exists app_expenses_method_json_idx on app_expenses ((data->>'method'));
      ...
      create index if not exists app_external_incomes_category_json_idx on app_external_incomes ((data->>'category'));
      create index if not exists app_external_incomes_method_json_idx on app_external_incomes ((data->>'method'));
      commit;
  `);
  postgresReady = true;
}
