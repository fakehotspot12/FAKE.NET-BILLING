...
const SAFE_DEVICE_REFRESH_PARAMETER_NAMES = Object.freeze([
  'InternetGatewayDevice.DeviceInfo.*',
  'InternetGatewayDevice.ManagementServer.ConnectionRequestURL',
  'InternetGatewayDevice.ManagementServer.PeriodicInformEnable',
  'InternetGatewayDevice.ManagementServer.PeriodicInformInterval',
  'InternetGatewayDevice.LANDevice.*.LANHostConfigManagement.IPRouters',
  'InternetGatewayDevice.LANDevice.*.LANHostConfigManagement.MinAddress',
  'InternetGatewayDevice.LANDevice.*.LANHostConfigManagement.MaxAddress',
  'InternetGatewayDevice.LANDevice.*.LANHostConfigManagement.DHCPServerEnable',
  ...
  'InternetGatewayDevice.LANDevice.*.WLANConfiguration.*.AssociatedDeviceNumberOfEntries',
  'InternetGatewayDevice.LANDevice.*.WLANConfiguration.*.WLAN_AssociatedDeviceNumberOfEntries',
  ...
  'InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANPPPConnection.*.ServiceList',
  'InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANPPPConnection.*.X_HW_ServiceList',
  'InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANPPPConnection.*.X_FH_ServiceList',
  ...
  'InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANPPPConnection.*.X_CMCC_ServiceList',
  'InternetGatewayDevice.WANDevice.*.WANConnectionDevice.*.WANPPPConnection.*.X_GC_ServiceList',
...
const DEFAULT_WAN_VLAN_PARAMETERS = [
  ...
  'InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnection.1.X_GC_VLANIDMark',
  'InternetGatewayDevice.WANDevice.1.WANConnectionDevice.2.WANPPPConnection.1.X_GC_VLANIDMark',
  'InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnection.1.X_GC_VLANID',
  'InternetGatewayDevice.WANDevice.1.WANConnectionDevice.2.WANPPPConnection.1.X_GC_VLANID',
...
async function refreshDevice(settings = {}, deviceId = '') {
  ...
  // some ONTs. Request only operational leaves so readback remains available
  // while GenieACS updates its parameter values.
  return task(settings, deviceId, {
    name: 'getParameterValues',
    parameterNames: SAFE_DEVICE_REFRESH_PARAMETER_NAMES.slice()
  });
}
...
module.exports = {
  ...
  _internal: {
    ...
    searchQuery,
    sameStringSet,
    safeDeviceRefreshParameterNames: () => SAFE_DEVICE_REFRESH_PARAMETER_NAMES.slice(),
